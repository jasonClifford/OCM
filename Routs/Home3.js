...
const InkVid = 'https://s3.ca-central-1.amazonaws.com/ocmediavideo/Main.mp4';
      ...
      return (
        <div className="mainContainer">
          ...
          <Video id="video2" controls autoPlay loop muted
              ...
              onCanPlayThrough={() => {
                  // Do stuff
                      var VidTime = this.refs.video1.videoEl.currentTime;
                      if (VidTime < "13") {
                          document.getElementById("video1").hide;
                          this.refs.video1.videoEl.hide;
                          this.refs.video2.videoEl.play();
                          console.log("Vid 1 is done");
                          console.log(VidTime);
